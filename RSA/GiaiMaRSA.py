# Form implementation generated from reading ui file 'GiaiMaRSA.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnMaHoaRSA.setGeometry(QtCore.QRect(430, 650, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.btnGiaiMaRSA.setGeometry(QtCore.QRect(260, 390, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnGiaiMaRSA.setFont(font)
        self.btnGiaiMaRSA.setObjectName("btnGiaiMaRSA")
        self.btnGiaiMaRSA.clicked.connect(self.btnGiaiMa_Click)
    ...
    def btnGiaiMa_Click(self):
        ...
        GiaiMa = RSA.GiaiMa(str(input), d, n)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Giải mã văn bản bằng RSA"))
