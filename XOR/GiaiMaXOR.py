# Form implementation generated from reading ui file 'GiaiMaXOR.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnGiaiMaXOR = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btnGiaiMaXOR.setGeometry(QtCore.QRect(250, 470, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnGiaiMaXOR.setFont(font)
        self.btnGiaiMaXOR.setObjectName("btnGiaiMaXOR")
        self.btnGiaiMaXOR.clicked.connect(self.btnGiaiMa_clicked)
        ...
        self.btnMaHoaXOR = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btnMaHoaXOR.setGeometry(QtCore.QRect(420, 720, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnMaHoaXOR.setFont(font)
        self.btnMaHoaXOR.setObjectName("btnMaHoaXOR")
...
# button Giai Ma
    def btnGiaiMa_clicked(self):
        ...
        lineEdit = int(self.lineEdit.text())
        GiaiMa = xor.MaHoa5(input,lineEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnGiaiMaXOR.setText(_translate("MainWindow", "Giải mã"))
        self.btnSave.setText(_translate("MainWindow", "Lưu File"))
        self.label_2.setText(_translate("MainWindow", "File Path:"))
        self.btnMaHoaXOR.setText(_translate("MainWindow", "Mã hóa"))
        self.btnBack.setText(_translate("MainWindow", "Back"))
        self.label.setText(_translate("MainWindow", "Giãi mã văn bản bằng XOR"))
