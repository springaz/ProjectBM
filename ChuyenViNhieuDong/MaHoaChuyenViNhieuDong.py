# Form implementation generated from reading ui file 'MaHoaChuyenViNhieuDong.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnGiaiMaChuyenViNhieuDong.setGeometry(QtCore.QRect(430, 650, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.btnMaHoaChuyenViNhieuDong.setGeometry(QtCore.QRect(260, 390, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnMaHoaChuyenViNhieuDong.setFont(font)
        self.btnMaHoaChuyenViNhieuDong.setObjectName("btnMaHoaChuyenViNhieuDong")
        self.btnMaHoaChuyenViNhieuDong.clicked.connect(self.btnMaHoa_Click)
    ...
    def btnMaHoa_Click(self):
        ...
        k=[3,5,6,7,2,1,4]
        MaHoa = chuyenvinhieudong.MaHoa(input, k)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Mã hóa văn bản bằng chuyển vị nhiều dòng"))
