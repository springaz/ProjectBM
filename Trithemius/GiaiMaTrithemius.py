# Form implementation generated from reading ui file 'GiaiMaTrithemius.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnMaHoaTrithemius = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btnMaHoaTrithemius.setGeometry(QtCore.QRect(430, 650, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnMaHoaTrithemius.setFont(font)
        self.btnMaHoaTrithemius.setObjectName("btnMaHoaTrithemius")
        self.btnGiaiMaTrithemius = QtWidgets.QPushButton(parent=self.centralwidget)
        self.btnGiaiMaTrithemius.setGeometry(QtCore.QRect(260, 390, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnGiaiMaTrithemius.setFont(font)
        self.btnGiaiMaTrithemius.setObjectName("btnGiaiMaTrithemius")
        self.btnGiaiMaTrithemius.clicked.connect(self.btnGiaiMa_Click)
    ...
    def btnGiaiMa_Click(self):
        ...
        GiaiMa = trithemius.GiaiMa(input)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnMaHoaTrithemius.setText(_translate("MainWindow", "Mã hóa"))
        self.btnGiaiMaTrithemius.setText(_translate("MainWindow", "Giải mã"))
        self.btnBack.setText(_translate("MainWindow", "Back"))
        self.btnChonFile.setText(_translate("MainWindow", "Chọn File"))
        self.btnSave.setText(_translate("MainWindow", "Lưu File"))
        self.label.setText(_translate("MainWindow", "Giải mã văn bản bằng Trithemius"))
